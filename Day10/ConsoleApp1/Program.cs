...
namespace TaskExample1
{
    internal class Program
    {
        static void Main2()
        {
           ...
           // Task t2=new Task(new Action(Func2));
        ...
        static void Func1()
        {
            for(int i = 0; i < 10; i++)
            {
                Console.WriteLine("Func1 called from {0},{1} ",Thread.CurrentThread.ManagedThreadId,i);
            }
        }
        static void Func2()
        {
            for (int i = 0; i < 10; i++)
            {
                Console.WriteLine("Func2 called from{0},{1}", Thread.CurrentThread.ManagedThreadId, i);
            }
        }
    }
}
...
namespace TaskExample3
{
    internal class Program
    {
        ...
        static void Func1(object obj)
        {
            for (int i = 0; i < 10; i++)
            {
                Console.WriteLine("Func1 called from {0},{1} ",i,obj.ToString());
            }
        }
        static void Func2(object obj)
        {
            for (int i = 0; i < 10; i++)
            {
                Console.WriteLine("Func2 called from{0},{1}", i, obj.ToString());
            }
        }
    }
}
