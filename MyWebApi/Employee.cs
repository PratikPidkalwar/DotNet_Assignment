...
namespace MyWebApi
{
    public class Employee
    {
        ...
        public static void Insert(Employee value)
        {
            ...
            try
            {
                ...
                InsertCmd.Parameters.AddWithValue("@EmpNo", value.EmpNo);
                InsertCmd.Parameters.AddWithValue("@Name", value.Name);
                InsertCmd.Parameters.AddWithValue("@Basic", value.Basic);
                InsertCmd.Parameters.AddWithValue("@DeptNo", value.DeptNo);
        ...
        public static void UpdateData(Employee obj)
        {
            SqlConnection sc = new SqlConnection();
            sc.ConnectionString = "Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=Exam;Integrated Security=True;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False";
            try
